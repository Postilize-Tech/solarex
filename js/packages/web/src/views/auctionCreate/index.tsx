  ...
  return (
    <>
      <Row className="call-to-action">
        <h2>List an item</h2>
        <p>
          First time listing on Solarex? <a>Read our sellers' guide.</a>
        </p>
      </Row>
  ...
  return (
    ...
    >
      ...
      <div className="waiting-title">
        Your creation is being listed with Solarex...
      </div>
...
const Congrats = (props: {
  ...
  const newTweetURL = () => {
    const params = {
      text: "I've created a new NFT auction on Solarex, check it out!",
      url: `${
        window.location.origin
      }/#/auction/${props.auction?.auction.toString()}`,
      hashtags: 'NFT,Crypto,Solarex',
      // via: "Solarex",
      related: 'Solarex,Solana',
    };
