...
import { processSolarexAccounts } from './processSolarexAccounts';
...
export function MetaProvider({ children = null as any }) {
  ...
  useEffect(() => {
    ...
    const solarexSubId = connection.onProgramAccountChange(
      toPublicKey(SOLAREX_ID),
      onChangeAccount(processSolarexAccounts, updateStateValue, all),
    );
    ...
    return () => {
      ...
      connection.removeProgramAccountChangeListener(solarexSubId);
