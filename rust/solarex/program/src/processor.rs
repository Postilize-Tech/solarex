use {
    crate::instruction::SolarexInstruction,
...
pub fn process_instruction<'a>(
    ...
    let instruction = SolarexInstruction::try_from_slice(input)?;
    match instruction {
        SolarexInstruction::DeprecatedInitAuctionManagerV1(auction_manager_settings) => {
        ...
        SolarexInstruction::DeprecatedValidateSafetyDepositBoxV1 => {
        ...
        SolarexInstruction::RedeemUnusedWinningConfigItemsAsAuctioneer(args) => {
        ...
        SolarexInstruction::ValidateSafetyDepositBoxV2(safety_deposit_config) => {
        ...
        SolarexInstruction::RedeemParticipationBidV3(args) => {
