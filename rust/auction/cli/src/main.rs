...
fn main() {
    let app_matches = App::new(crate_name!())
        ...
        //        .about("Add Token of X amount (default 1) to Inactive Solarex")
        //        .arg(
        ...
        //        .about("Redeem Shares from a Combined Solarex as a Shareholder")
        //        .arg(
        //            Arg::with_name("vault_authority")
        //                .long("vault_authority")
        //                .value_name("VAULT_AUTHORITY")
        ...
        //        .about("Withdraw Tokens from an Inactive or Combined Solarex Safety Deposit Box")
        //        .arg(
        //            Arg::with_name("vault_authority")
        //                .long("vault_authority")
        //                .value_name("VAULT_AUTHORITY")
